  ...
  <app-layout>
    <template #header>
      <h2 class="font-semibold text-xl leading-tight">
        <Link class="text-indigo-400 hover:text-indigo-600" :href="route('carros.index')">Carros
        </Link>
        ...
        <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
          <form @submit.prevent="submit" class="mb-6">
            <div class="grid grid-cols-1 md:grid-cols-2 gap-5 md:gap-8 mt-5 mx-7">
              ...
              <div class="grid grid-cols-1">
                <label class="
                    ...
                    font-semibold
                  ">Modelo</label>
                <input id="modelo" v-model="form.modelo" class="
                    py-2
                    px-3
                    rounded-lg
                    border-2 border-purple-300
                ...
                <p class="error text-red-700" v-if="errors.modelo">
                  {{ errors.modelo }}
                </p>
              </div>
              <div class="grid grid-cols-1">
                <label class="
                    ...
                    font-semibold
                  ">Marca</label>
                <input id="marca" v-model="form.marca" class="
                    py-2
                    px-3
                    rounded-lg
                    border-2 border-purple-300
                    ...
                    focus:border-transparent
                  " type="text" placeholder="" />
                <p class="error text-red-700" v-if="errors.marca">
                  {{ errors.marca }}
                </p>
              </div>
            ...
            <div class="flex justify-end md:gap-8 gap-4 pt-5 pb-5 pr-5">
              <Link :href="route('carros.index')" class="
                  w-auto
                  bg-gray-500
                  hover:bg-gray-700
                  rounded-lg
...
export default {
  ...
  methods: {
    submit() {
      this.$inertia.put(
        route("carros.update", this.$props.carro.id),
        this.form
      );
    },
  },
