                ...
                <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
                    <div class="flex justify-between h-16">
                        <div class="flex">
                            ...
                            <!-- Navigation Links -->
                            <div id="navigation-links" class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">

                                <jet-nav-link id="dashboard" :href="route('dashboard')" 
                                    class="
                                            text-xl
                                            font-bold
                                            text-gray-700
                                ...
                                <jet-nav-link id='carros-item-menu' :href="route('carros.index')" 
                                    class="
                                            text-xl
                                            font-bold
                                            text-gray-700
                                            ...
                                            hover:text-indigo-400
                                        "
                                    :active="route().current('carros.index')">Listar Carros
                                </jet-nav-link>
                                <!--endMenu-->
                            </div>
                        </div>
